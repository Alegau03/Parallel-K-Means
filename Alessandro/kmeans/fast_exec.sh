...
mpirun -np 4 ./kmeans_mpi test_files/input100D2.inp 6 300 10 0.0001 test_files/output2d_mpi.txt
echo "Fine run versione MPI"
gcc-14 -fopenmp -o kmeans_openmp KMEANS_omp.c -lm
echo "Inizio run versione OpenMP"
./kmeans_openmp test_files/input100D2.inp 6 300 10 0.0001 test_files/output2d_omp.txt
echo "Fine run versione OpenMP"
gcc KMEANS.c -o kmeans
echo "Inizio run versione sequenziale"
./kmeans test_files/input100D2.inp 6 300 10 0.0001 test_files/output2d_seq.txt
