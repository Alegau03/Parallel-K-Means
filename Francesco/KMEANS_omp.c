...
Modificata eliminando la radice quadrata e usando divisione in blocchi per
diminuire i chache miss La radice quadrata non è necessaria per confrontare le
distanze relative tra punti e centroidi, poiché il confronto è valido anche con
le distanze al quadrato. Evitare il calcolo della radice quadrata migliora
